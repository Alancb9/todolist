...
const TodoList = ({todos, delTodo, update_todo, complete_todo, filter_todo}) => {
  ...
  return (
    ...
    <div className="todo-list">
        ...
        { todos.map((todo, index) => (
            <div className="todo-list-item" key={ index }>
                <div className="task">
                <input checked={todo.completadas} type="checkbox" onChange={(e) => complete_todo(e, todo.id, todo)}/>
                <p id = "strike" className = {todo.completadas == true? "strike":"" } >{todo.tareas}</p>
                </div>
                <div className="btn-container">
                <div className="edit"> <TbEdit size={25} onClick={(e) => todoItem(todo.tareas, todo.id, todo) } /> </div>
    ...
    { toggle &&  <div className="modal-container">
      <div className="modal">
        <h1>Update Form</h1>
          <form action="" onSubmit = { (e) => {update_todo(e, todoId, tareas); setToggle(false)} }>
